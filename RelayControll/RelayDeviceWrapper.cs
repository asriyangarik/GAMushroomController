...
namespace USB_Relay_Control
{
    ...
    public struct usb_relay_device_info
    {
        ...
        {
            return device_path.ToInt32().ToString() + " (" + serial_number + ")";
        }
    }
    ...
    public class RelayDeviceWrapper
    {
        ...
        [DllImport("usb_relay_device.dll", EntryPoint = "usb_relay_device_open", SetLastError = true,
        CharSet = CharSet.Ansi, ExactSpelling = true,
        CallingConvention = CallingConvention.Cdecl)]
        ...
        CharSet = CharSet.Ansi, ExactSpelling = true,
        CallingConvention = CallingConvention.Cdecl)]
        public static extern int usb_relay_device_get_status(int hHandle, ref uint status);
    }
}
